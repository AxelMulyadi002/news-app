...
import senja from '@/img/senja.webp';
import putri from '@/img/putri.webp';
import mahalini from '@/img/mahalini.webp';
import raisa from '@/img/raisa.webp';
import nevach from '@/img/nevach.webp';
...
const listData = [
	{
		...
		headline: 'Ariel Noah dkk Segera Vakum Lama',
		source: 'Alvin Harrisa Yoso',
		...
		video: 'https://youtu.be/hyWsmc_kaLM?feature=shared',
	},
	{
		id: 8,
		source: 'Alvin Harissa Yoso',
		headline:
			"Senja Teduh Pelita Maliq & D'essentials X Coldplay Mots Live From GBK Jakarta",
		title:
			"Senja Teduh Pelita Maliq & D'essentials X Coldplay Mots Live From GBK Jakarta",
		url: senja,
		image: senja,
		text: 'Kabar membanggakan hadir pada musisi tanah air MALIQ & D”ESSENTIALS  dimana secara mengejutkan hadir dalam konser COLDPLAY yang di selenggarakan di Gelora Bung Karno Jakarta pada 15 November 2023.',
		textkedua:
			'Band yang berusia 20 tahun itu menceritakan pengalamanya bagaimana ia bisa sampai konser bareng musisi COLDPLAY "Awalnya dari label kami, Warner, bilang ada semacam gathering rahasia sama Chris Martin," ujar Angga dalam wawancara bersama Pop Hari Ini, Jumat (17/11). Vokalis dari coldplay sendiri yang kemudian ingin mendengarkan atau hearing session bersama MALIQ & D”ESSENTIALS.',
		textketiga:
			'MALIQ & D”ESSENTIALS  sendiri membawakan beberapa lagu diantaranya adalah lagu baru mereka yang belom dirilis dan pertama kalinya secara special lagu yang berjudul “aduh” di nyanyikan di depan ribuan orang . selain itu mereka juga membawakan lagu hits mereka “enja Teduh Pelita”',
		textkeempat:
			'Tentunya dengan penampilan mendadak yang membuat heboh ribuan orang di GBK tersebut membuat banyak orang yang kagum dan speechless akan penampilan MALIQ & D”ESSENTIALS. pasalnya tidak semua band Indonesia mendapat kesemppatan untuk melakukan hal tersebut.',
		textkelima:
			'COLDPLAY sendiri memang mengusung konsep untuk berkolaborasi pada musisi lokal di negara yang ia singgahi saat konser, karena tema dalam tour kali ini adalah music of the sphere yang dimana kolaborasi serta perpaduan dengan berbagai nuansa musiklah yang di harapkan oleh COLDPLAY.',
		video: 'https://youtu.be/1q3LDzoz9q4?feature=shared',
	},
	{
		id: 9,
		url: putri,
		image: putri,
		headline: 'Penampilan Kece Putri Riani Dalam Debat Capres Perdana',
		source: 'Axel Mulyadi',
		title: 'Penampilan Kece Putri Riani Dalam Debat Capres Perdana',
		text: "SukaMusik, Tangerang - Putri Riani tampil bernyanyi dalam debat Capres yang digelar pada tanggal, Selasa 12 Desember 2023. Peraih Golden Buzzer America's Got Talent 2023 itu membawakan tiga lagunya, yakni Mimpi, Loneliness, serta Permata Indah Dunia.",
		textkedua:
	...
	{
		id: 10,
		headline: 'Sial Mahalini Meraih Penghargaan Song of The Year di IMA 2023',
		source: 'Axel Mulyadi',
		url: mahalini,
		image: mahalini,
		title: 'Sial Mahalini Meraih Penghargaan Song of The Year di IMA 2023',
		text: 'Mahalini Berhasil membawa pulang piala Song Of The Year IMA 2023 pada tanggal, Kamis 7 Desember 2023. Ini bukanlah pertama kali mahalini berhasil membawa pulang piala Song Of The Year. Tahun lalu mahalini berhasil membawa pulang piala dari lagu “Kisah Sempurna”, pada tahun ini dia berhasil membawa pulang dari lagu “Sial”.',
		textkedua:
			'Mahalini tampil dengan sangat cantik menggunakan gaun berwarna hijau dengan gaya rambut dikuncir dan dikepang. Lagu Sial Mahalini dari awal pertama kali rilis sudah mendapat banyak tuaian positif dikarenakan lagunya yang enak di dengar dan suara Mahalini yang merdu ditelinga.',
		textketiga:
	...
	},
	{
		...
		headline:
			'Rilisan Baru Berjudul  Raisa – Tak Berharap Lagi Buat Para Sukamusikers Yang Weekendnya Galau.',
		title:
			'Rilisan Baru Berjudul  Raisa – Tak Berharap Lagi Buat Para Sukamusikers Yang Weekendnya Galau.',
		url: raisa,
		image: raisa,
		text: 'Musisi tanah air Raisa Andriana, dan Andmesh Kamaleng baru saja merilis single terbarunya nih sobat SukaMusikers yang berjudul Tak Berharap Lagi. Lagu ini ditulis oleh Andmesh namun menurut Andmesh lagu ini cocok jika dibawakan oleh raisa Andriana sehingga mereka berdua berkolaborasi dan merilis lagu tersebut di tanggal 15 Desember 2023 lalu.',
		textkedua:
	...
	},
	{
		...
		url: nevach,
		image: nevach,
		text: 'Band Nevach merupakan band asal bali yang beranggotakan Kevin diaz sebagai vokalis, Aris f sebagai bass, Agung agrales sebagai gitaris, Abe sebagai synthesizer, dan Riszy yang mejadi drummer. Tahu gak si sobat SukaMusikers kemarin di tanggal 12 desember 2023 band ini baru saja merilis lagu terbaru mereka yang berjudul “ Ruang Hampa “ lagu ini ditulis langsung oleh vokalis mereka yaitu Kevin diaz . lagu ini menurut penjelasan dari Kevin bertemakan broken home, sebab Kevin sendiri bercerita bahwa ia terinspirasi dari kisah hidup nya sendiri yaitu sebagai anak broken home karena kedua orangtuanya bercerai sehingga ia pun mengambil tema broken home untuk menciptakan lagu tersebut.',
		textkedua:
		...
		textketiga:
			'Nah untuk para sobat SukaMusikers yang ingin mendengarkan langsung lagu ini mungkin sobat SukaMusikers bisa langsung saja membuka link berikut ini: ',
